                            ...
                            <div class="panel panel-default padding-10 no-borders">
                                <div class="panel-body">
                                    ...
                                    <div class="m-b-10 m-t-25 text-center collapse in" id="filter">
                                        <div class="row">
                                            <div class="col-xs-5">
                                                <div class="radio radio-primary m-t-0">
                                                    <input id="kfk-dni" name="inlineType" type="radio"/>
                                                    <label for="kfk-dni">
                                                        DNI
                                                    </label>
                                                </div>
                                        ...
                                        <br/>
                                        <div class="text-center col-xs-10 col-xs-offset-1 m-b-20  kfk-row">
                                    ...
                                    <div class="panel-body p-t-0 text-center table-responsive" style="font-size:14px">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-xs-12">
                                                ...
                                                <hr class="visible-xs"/>
                                                <div class="text-left">
                                                    <div class="hidden-xs m-t-80">
                                                    </div>
                                                    <small class="m-l-50">
                                                        Monto Solicitado:
                                                    </small>
                                                    <h2 class="text-center m-t-0 text-grey">
                                                        S/. 8,000
                                                    </h2>
                                                </div>
                                            </div>
